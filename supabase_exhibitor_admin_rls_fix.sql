...
-- ============================================================
-- 執行目的：允許主辦單位管理員信箱（artwithlifetaipei@gmail.com、ameliecykuo@gmail.com 與 amelie@theartpressasia.com）
...
TO authenticated
USING (auth.jwt() ->> 'email' IN ('artwithlifetaipei@gmail.com', 'ameliecykuo@gmail.com', 'amelie@theartpressasia.com'))
WITH CHECK (auth.jwt() ->> 'email' IN ('artwithlifetaipei@gmail.com', 'ameliecykuo@gmail.com', 'amelie@theartpressasia.com'));
