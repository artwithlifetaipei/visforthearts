        ...
        <div className="space-y-4 text-[#DFBA87] text-xs font-light leading-relaxed">
          ...
          <div>
            ...
            <p className="text-neutral-400 mb-2">
              品牌方支付之所有對價僅限包含：(1) 雙方協議之展位規格、(2) 參展暨佈撤展期間 (2027/1/6 10:00 ~ 1/9 21:30) [包含 1/6 10:00-17:00 佈展、1/6 18:00-21:30 VIP 預展與開幕酒會、1/7-1/9 公眾展期，以及 1/9 19:00-21:30 撤場]、(3) 貴賓卡 20-40 張、(4) 展商工作證 4 張。
            </p>
