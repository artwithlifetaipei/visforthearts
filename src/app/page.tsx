...
export default function LandingPage() {
    ...
    useEffect(() => {
        ...
        const initAnimations = async () => {
            ...
            // 3. Exhibition Horizontal Scroll
        ...
        <main className="landing-root">
            <style jsx global>{`
                ...
                * {
                ...
                .press-item { border-bottom: 1px solid var(--border); padding-bottom: 2rem; }
                .press-img { width: 100%; aspect-ratio: 16/9; object-fit: cover; margin-bottom: 1rem; }
                .press-media { font-size: 2rem; font-family: var(--font-serif); font-style: italic; }
            ...
            <section className="exhibition-section" id="exhibition">
                <div className="exhibition-scroller">
                    ...
                    <div className="exhibit-item">
                        ...
                        <p className="card-text-zh">精準觸及兼具高消費力與生活美學品味的場域</p>
                    </div>
                </div>
            </section>
            ...
            <section className="press-section" id="press">
                ...
                <div className="press-grid">
                    <div className="press-item">
                        <img src="https://img1.wsimg.com/isteam/ip/e6b4acac-1653-4d0e-9e55-ed5572206955/GettyImages-2209624027-1024x683.jpg" className="press-img" alt="Press 1" />
                        <h3 className="press-media">artnet</h3>
                        <p style={{ fontSize: '0.9rem', color: '#666' }}>New Art Fair Alternative Plans 2026 Launch in Taipei, Hong Kong</p>
                    </div>
                    <div className="press-item">
                        <img src="https://img1.wsimg.com/isteam/ip/e6b4acac-1653-4d0e-9e55-ed5572206955/hong-kong4-1.jpg" className="press-img" alt="Press 2" />
                        <h3 className="press-media">Prestige</h3>
                        <p style={{ fontSize: '0.9rem', color: '#666' }}>週末逛街好去處！從時尚、藝術與居家設計感受來自日本、台灣以及香港獨立品牌魅力</p>
                    </div>
                    <div className="press-item">
                        <img src="https://img1.wsimg.com/isteam/ip/e6b4acac-1653-4d0e-9e55-ed5572206955/%E6%9C%A8%E4%BB%8B%E7%94%9F%E6%B4%BBMujieLiving_2025%20Lifestyle%20and%20Art%20Festiva.jpg" className="press-img" alt="Press 3" />
                        <h3 className="press-media">Mujie Living</h3>
                        <p style={{ fontSize: '0.9rem', color: '#666' }}>當代社會品味或風格，藝術如何自外於生活？全台首個以生活為核心的藝術節</p>
                    </div>
                </div>
            </section>
